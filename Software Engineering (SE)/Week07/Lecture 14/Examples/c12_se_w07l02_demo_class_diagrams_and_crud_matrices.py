...
*association* between a book and its borrowing records.
        ...
        -- The Diagram: Note: When opening draw.io, find template under new diagram,software, class 2
                        Note: See draw.io file for a better visual
+---------------------------+   +----------------------------------------------------------+
|      Library              |   |     Librarian                                            |
+---------------------------+   +----------------------------------------------------------+
| - name: str               |   | - name: str                                              |
        ...
        for book in self.books:
            if book.isbn == isbn:
                for key, value in kwargs.items():
                    # The setattr(object, name, value) function allows you 
                    # to set the value of an attribute on an object dynamically 
                    # at runtime. Same as book.key = value
